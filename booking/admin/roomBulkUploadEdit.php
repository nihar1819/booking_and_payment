...
if(isset($_REQUEST['action']) && $_REQUEST['action']=='add'){
	...
	$extra_child=$_REQUEST['extra_child'];
			...
			$dbf->updateTable("room_price",$str1,"id='$_REQUEST[id]'");
		
	
	
	header("location:roomPriceDetails.php?id=$_REQUEST[rid]");
}

$val=$dbf->fetchSingle("room_price","*","id='$_REQUEST[id]'");
?>    
          ...
          <div class="vd_head-section clearfix">
            <div class="vd_panel-header">
              <ul class="breadcrumb">
                ...
                <li class="active">Edit Room Price</li>
              </ul>
          ...
          <div class="vd_content-section clearfix">
            <div class="panel widget light-widget">
              ...
              <div class="panel-body">
                ...
                <form class="form-horizontal" action="roomBulkUploadEdit.php?action=add&id=<?php echo $_REQUEST['id']; ?>&rid=<?php echo $_REQUEST['rid']; ?>" method="post" role="form" name="frm" id="frm" enctype="multipart/form-data">
                   ...
                   <div class="form-group">
                    <div class="col-md-12">
                      ...
                      <div id="company-input-wrapper" class="controls col-sm-6">
                        <input class="width-60" required="required" name="from_date" id="from_date" type="date" value="<?php echo $val['room_plan_date']; ?>" >
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-md-12">
                      ...
                      <div id="company-input-wrapper" class="controls col-sm-6">
                        <input class="width-60" name="sell_rate_one" id="sell_rate_one" type="text" placeholder="Price (single person)" required value="<?php echo $val['sell_rate_one']; ?>" >
                      </div>
                    </div>
                  </div>
                    <div class="form-group">
                    <div class="col-md-12">
                      ...
                      <div id="company-input-wrapper" class="controls col-sm-6">
                        <input class="width-60" name="sell_rate_two" id="sell_rate_two" type="text" placeholder="Price (Two person)" value="<?php echo $val['sell_rate_two']; ?>">
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-md-12">
                      ...
                      <div id="company-input-wrapper" class="controls col-sm-6">
                        <input class="width-60" name="tax_one" id="tax_one" type="text" placeholder="TAX (One person)" value="<?php echo $val['tax_one']; ?>">
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-md-12">
                      ...
                      <div id="company-input-wrapper" class="controls col-sm-6">
                        <input class="width-60" name="tax_two" id="tax_two" type="text" placeholder="TAX (Two person)" value="<?php echo $val['tax_two']; ?>">
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-md-12">
                      ...
                      <div id="company-input-wrapper" class="controls col-sm-6">
                        <input class="width-60" name="extra_adult" id="extra_adult" type="text" placeholder="Price for Extra Adult" value="<?php echo $val['extra_adult']; ?>">
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-md-12">
                      ...
                      <div id="company-input-wrapper" class="controls col-sm-6">
                        <input class="width-60" name="extra_child" id="extra_child" type="text" placeholder="Price for Extra Child" value="<?php echo $val['extra_child']; ?>">
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
