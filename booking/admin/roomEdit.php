...
ImageJPEG($destimg1,$destination_path1,100) or die("Problem In saving"); 
	...
	$description=addslashes($_REQUEST['description']);
	$string="type_id='$_REQUEST[type_id]', description='$description', price='$_REQUEST[price]', price_for_extra='$_REQUEST[price_for_extra]', price_for_extra_child='$_REQUEST[price_for_extra_child]'";
	}
	$dbf->updateTable("rooms",$string,"id='$_REQUEST[id]'");
	$dbf->deleteFromTable("room_child","room_id='$_REQUEST[id]'");
	$fac=$_REQUEST['facility_id'];
	$cnt=count($fac);
	for($i=0;$i<$cnt;$i++){
		$fac_id=$fac[$i];
		$string1="room_id='$_REQUEST[id]', facility_id='$fac_id'";
		$dbf->insertSet("room_child",$string1);
	}
	header("location:manageRooms.php");
}

$val=$dbf->fetchSingle("rooms","*","id='$_REQUEST[id]'");
?>    
          ...
          <div class="vd_content-section clearfix">
            <div class="panel widget light-widget">
              ...
              <div class="panel-body">
                ...
                <form class="form-horizontal" action="roomEdit.php?action=addCountry&id=<?php echo $_REQUEST['id']; ?>" method="post" role="form" name="frm" id="frm" enctype="multipart/form-data">
                 ...
                 <div class="form-group">
                   ...
                   <div class="form-group">
                    <div class="col-md-12">
                      ...
                      <div id="company-input-wrapper" class="controls col-sm-6">
                        <input placeholder="Price" class="width-60" required="required" name="price" id="price" type="text" value="<?php echo $val['price']; ?>">
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-md-12">
                      ...
                      <div id="company-input-wrapper" class="controls col-sm-6">
                        <input placeholder="Price Extra Bed" class="width-60" required="required" name="price_for_extra" id="price_for_extra" type="text" value="<?php echo $val['price_for_extra']; ?>">
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-md-12">
                      ...
                      <div id="company-input-wrapper" class="controls col-sm-6">
                        <input placeholder="Price Extra Bed" class="width-60" required="required" name="price_for_extra_child" id="price_for_extra_child" type="text" value="<?php echo $val['price_for_extra_child']; ?>">
                      </div>
                    </div>
                  </div> 
                  <div class="form-group">
                    <div class="col-md-12">
                      ...
                      <div id="company-input-wrapper" class="controls col-sm-6">
                        <input  class="width-60"  name="img" id="img" type="file" ><img src="../room/<?php echo $val['img'] ?>" height="60" width="60">
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
