      ...
      <div class="vd_top-menu-wrapper">
        <div class="container ">
          ...
          <div class="vd_panel-header">
          	<div class="logo" style="font-size:14px; font-weight:bold; text-align:center;">
            	<a href="dashboard.php"><img src="img/logo2.png"></a>
            </div>
            <!-- logo -->
    ...
    <li id="top-menu-profile" class="profile mega-li"> 
        <a href="#" class="mega-link"  data-action="click-trigger"> 
            ...
            <span class="mega-name">
                <?php echo $adm['user_name'];?> <i class="fa fa-caret-down fa-fw"></i> 
            </span>
        </a> 
        ...
        <div class="child-menu"> 
        	<div class="content-list content-menu">
                <ul class="list-wrapper pd-lr-10">
                   <li> <a href="editProfile.php"> <div class="menu-icon"><i class=" fa fa-user"></i></div> <div class="menu-text">Edit Profile</div> </a> </li>
				   <li> <a href="changePassword.php"> <div class="menu-icon"><i class=" fa fa-user"></i></div> <div class="menu-text">Change Password</div> </a> </li>
