...
if(isset($_REQUEST['action']) && $_REQUEST['action']=='addCountry'){
	...
	$dbf->insertSet("room_type",$string);
          ...
          <div class="vd_content-section clearfix">
            <div class="panel widget light-widget">
              ...
              <div class="panel-body">
                ...
                <form class="form-horizontal" action="roomTypeAdd.php?action=addCountry" method="post" role="form" name="frm" id="frm" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    <div class="col-md-12">
                      ...
                      <div id="company-input-wrapper" class="controls col-sm-6">
                        <input placeholder="Room Type" class="width-60" required="required" name="room_type" id="room_type" type="text">
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-md-12">
                      ...
                      <div id="company-input-wrapper" class="controls col-sm-6">
                        <input placeholder="No of Rooms" class="width-60" required="required" name="no_of_rooms" id="no_of_rooms" type="text">
                      </div>
                    </div>
                  </div>
                <div class="form-group">
                    <div class="col-md-12">
                      ...
                      <div id="company-input-wrapper" class="controls col-sm-6">
                        <input placeholder="Tax" class="width-60" required="required" name="tax" id="tax" type="text" value="0">
                      </div>
                    </div>
                  </div>
