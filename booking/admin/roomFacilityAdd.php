...
if(isset($_REQUEST['action']) && $_REQUEST['action']=='addCountry'){
	...
	$dbf->insertSet("room_facility",$string);
          ...
          <div class="vd_head-section clearfix">
            <div class="vd_panel-header">
              <ul class="breadcrumb">
                ...
                <li class="active">Add Room Facility</li>
              </ul>
          ...
          <div class="vd_content-section clearfix">
            <div class="panel widget light-widget">
              ...
              <div class="panel-body">
                ...
                <form class="form-horizontal" action="roomFacilityAdd.php?action=addCountry" method="post" role="form" name="frm" id="frm" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    <div class="col-md-12">
                      ...
                      <div id="company-input-wrapper" class="controls col-sm-6">
                        <input placeholder="Room Facility" class="width-60" required="required" name="facility" id="facility" type="text">
                      </div>
                    </div>
                  </div>
