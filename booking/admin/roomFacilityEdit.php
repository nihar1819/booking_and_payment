...
if(isset($_REQUEST['action']) && $_REQUEST['action']=='addCountry'){
	...
	$string="facility='$_REQUEST[facility]'";
	$dbf->updateTable("room_facility",$string,"id='$_REQUEST[id]'");
	header("location:manageRoomFacility.php");
}

$fac=$dbf->fetchSingle("room_facility","*","id='$_REQUEST[id]'");
?>    
          ...
          <div class="vd_head-section clearfix">
            <div class="vd_panel-header">
              <ul class="breadcrumb">
                ...
                <li><a href="manageRoomFacility.php">Manage Room Facility</a> </li>
                <li class="active">Edit Room Facility</li>
              </ul>
          ...
          <div class="vd_content-section clearfix">
            <div class="panel widget light-widget">
              ...
              <div class="panel-body">
                ...
                <form class="form-horizontal" action="roomFacilityEdit.php?action=addCountry&id=<?php echo $_REQUEST['id']; ?>" method="post" role="form" name="frm" id="frm" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    <div class="col-md-12">
                      ...
                      <div id="company-input-wrapper" class="controls col-sm-6">
                        <input placeholder="Room Facility" class="width-60" required="required" name="facility" id="facility" type="text" value="<?php echo $fac['facility']; ?>">
                      </div>
                    </div>
                  </div>
